...
function setStatus(selector, status) {
  ...
  el.forEach(function (e) {
    ...
    // @ts-ignore
    ;(_c =
      (_b = (_a = e.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement) ===
        null || _b === void 0
        ? void 0
        : _b.parentElement) === null || _c === void 0
      ? void 0
      : (_c.style.display = status)
  })
}
...
;(_a = injectLoc === null || injectLoc === void 0 ? void 0 : injectLoc.parentNode) === null ||
_a === void 0
  ? void 0
  : _a.insertBefore(filterArea, injectLoc.nextSibling)
